...
| AI Panel                   | `1007:3700` (`1079:3141`, desktop instances within `1127:4196`/`1127:4197`)                                  | `packages/ui/src/composite/AIPanel.tsx`                                                                                                                                   | `Composite/AIPanel`; composed in `Layout/AppShell`                                                          | Synced — exact 304px structure, theme tokens, and exported `lm-ai-outline` glyph; live-region behavior covered structurally, React only                                                                                                                                                          | 2026-07-20   |
| Button (`accent` variant)  | `1007:3700` (`1127:4196`, `1127:4197`, `btn/accent/*` variables)                                             | `packages/ui/src/primitives/Button.tsx`, `packages/web-components/src/button/lumen-button.ts`, `packages/angular/src/button/lumen-button.ts`                              | `Primitives/Button` (`AllVariants` story); composed in `Layout/AppShell`                                    | Synced for sourced states — exact light/dark semantic roles; Figma defines only Default, so React adds no unsourced hover/active visual treatment and retains the shared accessible focus ring                                                                                                   | 2026-07-20   |
