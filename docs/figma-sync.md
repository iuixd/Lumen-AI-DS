...
| Button                     | `1027:3733` (variant/state collection `1174:1349`); `1034:4459` (sizes)                                          | `packages/ui/src/primitives/Button.tsx`, `packages/web-components/src/button/lumen-button.ts`, `packages/angular/src/button/lumen-button.ts`                              | `Primitives/Button` (`FinalVariantCollection`, `Sizes`)                                                     | Synced — all 48 combinations of the six current Figma variants (`primary`, `accent`, `secondary`, `outline`, `ghost`, `destructive`), four states, and two themes are implemented; all 12 Hover instances have exact surface, foreground, and border bindings, and Link was removed from the standard Button contract. The 30/34/38/42px `sm`/`md`/`lg`/`xl` size scale is implemented with `md` as default.                                                                                                                                                                                                                                                                                                                         | 2026-07-23   |
