...
| Button                     | `1027:3733` (collection frame `1174:1349`)                                                                       | `packages/ui/src/primitives/Button.tsx`, `packages/web-components/src/button/lumen-button.ts`, `packages/angular/src/button/lumen-button.ts`                              | `Primitives/Button` (`FinalVariantCollection`)                                                              | User-directed scope — Link is intentionally excluded from the shipped standard Button collection. The six supported variants are Primary, Accent, Secondary, Outline, Ghost, and Destructive, using the 34px geometry and published light/dark state roles. Use TextLink or a semantic anchor for navigation; AIButton's independent Link variant is unchanged.                                                                                                                                                                                                                                                                                                                                                                      | 2026-07-22   |
