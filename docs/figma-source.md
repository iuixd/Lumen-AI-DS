...
| Buttons    | `1174:1349`             | Published (Light + Dark via Figma variable modes, not separate variant instances; real `Theme=Dark` instances also confirmed 2026-08-04 — `neutral`/`neutral-solid`/disabled/`ghost-on-action` corrected against them; Accent/Link variants declared, not yet authored) | Synced | Synced | 2026-08-04 |
