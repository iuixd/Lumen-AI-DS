...
module.exports = {
  ...
  "neutral-white-a32": "var(--color-neutral-white-a32)",
  "neutral-white-a40": "var(--color-neutral-white-a40)",
  "neutral-white-a48": "var(--color-neutral-white-a48)",
  "neutral-white-a56": "var(--color-neutral-white-a56)",
  "neutral-white-a72": "var(--color-neutral-white-a72)",
  "neutral-white-a80": "var(--color-neutral-white-a80)",
  "neutral-500-a8": "var(--color-neutral-500-a8)",
  "neutral-500-a16": "var(--color-neutral-500-a16)",
  "neutral-500-a24": "var(--color-neutral-500-a24)",
  "neutral-500-a40": "var(--color-neutral-500-a40)",
  "neutral-500-a60": "var(--color-neutral-500-a60)",
  "neutral-500-a80": "var(--color-neutral-500-a80)",
  ...
  "primary-500-a8": "var(--color-primary-500-a8)",
  "primary-500-a16": "var(--color-primary-500-a16)",
  "primary-500-a24": "var(--color-primary-500-a24)",
  "primary-500-a60": "var(--color-primary-500-a60)",
  "primary-500-a40": "var(--color-primary-500-a40)",
  "primary-500-a80": "var(--color-primary-500-a80)",
  ...
  "lumen-gray-900": "var(--color-lumen-gray-900)",
  "lumen-gray-950": "var(--color-lumen-gray-950)",
  "lumen-gray-500-a8": "var(--color-lumen-gray-500-a8)",
  "lumen-gray-500-a16": "var(--color-lumen-gray-500-a16)",
  "lumen-gray-500-a24": "var(--color-lumen-gray-500-a24)",
  "lumen-gray-500-a40": "var(--color-lumen-gray-500-a40)",
  "lumen-gray-500-a60": "var(--color-lumen-gray-500-a60)",
  "lumen-gray-500-a80": "var(--color-lumen-gray-500-a80)",
  ...
  "red-500-a8": "var(--color-red-500-a8)",
  "red-500-a16": "var(--color-red-500-a16)",
  "red-500-a24": "var(--color-red-500-a24)",
  "red-500-a40": "var(--color-red-500-a40)",
  "red-500-a60": "var(--color-red-500-a60)",
  "red-500-a80": "var(--color-red-500-a80)",
  ...
  "green-500-a8": "var(--color-green-500-a8)",
  "green-500-a16": "var(--color-green-500-a16)",
  "green-500-a24": "var(--color-green-500-a24)",
  "green-500-a40": "var(--color-green-500-a40)",
  "green-500-a60": "var(--color-green-500-a60)",
  "green-500-a80": "var(--color-green-500-a80)",
  ...
  "orange-500-a8": "var(--color-orange-500-a8)",
  "orange-500-a16": "var(--color-orange-500-a16)",
  "orange-500-a24": "var(--color-orange-500-a24)",
  "orange-500-a40": "var(--color-orange-500-a40)",
  "orange-500-a60": "var(--color-orange-500-a60)",
  "orange-500-a80": "var(--color-orange-500-a80)",
  ...
  "yellow-500-a8": "var(--color-yellow-500-a8)",
  "yellow-500-a16": "var(--color-yellow-500-a16)",
  "yellow-500-a24": "var(--color-yellow-500-a24)",
  "yellow-500-a40": "var(--color-yellow-500-a40)",
  "yellow-500-a60": "var(--color-yellow-500-a60)",
  "yellow-500-a80": "var(--color-yellow-500-a80)",
  ...
  "purple-500-a8": "var(--color-purple-500-a8)",
  "purple-500-a16": "var(--color-purple-500-a16)",
  "purple-500-a24": "var(--color-purple-500-a24)",
  "purple-500-a40": "var(--color-purple-500-a40)",
  "purple-500-a60": "var(--color-purple-500-a60)",
  "purple-500-a80": "var(--color-purple-500-a80)",
  ...
  "pink-500-a8": "var(--color-pink-500-a8)",
  "pink-500-a16": "var(--color-pink-500-a16)",
  "pink-500-a24": "var(--color-pink-500-a24)",
  "pink-500-a40": "var(--color-pink-500-a40)",
  "pink-500-a60": "var(--color-pink-500-a60)",
  "pink-500-a80": "var(--color-pink-500-a80)",
  ...
  "light-blue-950": "var(--color-light-blue-950)",
  "light-blue-500-a8": "var(--color-light-blue-500-a8)",
  "light-blue-500-a16": "var(--color-light-blue-500-a16)",
  "light-blue-500-a24": "var(--color-light-blue-500-a24)",
  "light-blue-500-a40": "var(--color-light-blue-500-a40)",
  "light-blue-500-a60": "var(--color-light-blue-500-a60)",
  "light-blue-500-a80": "var(--color-light-blue-500-a80)",
  ...
  "teal-500-a8": "var(--color-teal-500-a8)",
  "teal-500-a16": "var(--color-teal-500-a16)",
  "teal-500-a24": "var(--color-teal-500-a24)",
  "teal-500-a40": "var(--color-teal-500-a40)",
  "teal-500-a60": "var(--color-teal-500-a60)",
  "teal-500-a80": "var(--color-teal-500-a80)",
  ...
  "deep-purple-900": "var(--color-deep-purple-900)",
  "deep-purple-950": "var(--color-deep-purple-950)",
  "deep-purple-500-a8": "var(--color-deep-purple-500-a8)",
  "deep-purple-500-a16": "var(--color-deep-purple-500-a16)",
  "deep-purple-500-a24": "var(--color-deep-purple-500-a24)",
  ...
  "blue-500-a8": "var(--color-blue-500-a8)",
  "blue-500-a16": "var(--color-blue-500-a16)",
  "blue-500-a24": "var(--color-blue-500-a24)",
  "blue-500-a40": "var(--color-blue-500-a40)",
  "blue-500-a60": "var(--color-blue-500-a60)",
  ...
  "app-shell-light-nav-hover": "var(--color-app-shell-light-nav-hover)",
  ...
  "app-shell-light-assistant-icon-bg": "var(--color-app-shell-light-assistant-icon-bg)",
  ...
  "app-shell-dark-border-subtle": "var(--color-app-shell-dark-border-subtle)",
  "app-shell-dark-nav-active": "var(--color-app-shell-dark-nav-active)",
  "app-shell-dark-nav-hover": "var(--color-app-shell-dark-nav-hover)",
  "app-shell-dark-nav-on-action": "var(--color-app-shell-dark-nav-on-action)",
  "app-shell-dark-nav-selected-on-action": "var(--color-app-shell-dark-nav-selected-on-action)",
  ...
  "app-shell-dark-toggle-on-action": "var(--color-app-shell-dark-toggle-on-action)",
  "app-shell-dark-toggle-off-action": "var(--color-app-shell-dark-toggle-off-action)",
  "app-shell-dark-chat-response-bg": "var(--color-app-shell-dark-chat-response-bg)",
  ...
  "app-shell-dark-badge-success-bg": "var(--color-app-shell-dark-badge-success-bg)",
  "app-shell-dark-badge-warning-bg": "var(--color-app-shell-dark-badge-warning-bg)",
  "app-shell-dark-button-accent-on-action": "var(--color-app-shell-dark-button-accent-on-action)",
  ...
  "code-syntax-keyword": "var(--color-code-syntax-keyword)",
  "code-syntax-string": "var(--color-code-syntax-string)",
  "lumen-dark-50": "var(--color-lumen-dark-50)",
  "lumen-dark-100": "var(--color-lumen-dark-100)",
  "lumen-dark-200": "var(--color-lumen-dark-200)",
  "lumen-dark-300": "var(--color-lumen-dark-300)",
  "lumen-dark-400": "var(--color-lumen-dark-400)",
  "lumen-dark-600": "var(--color-lumen-dark-600)",
  "lumen-dark-700": "var(--color-lumen-dark-700)",
  "lumen-dark-800": "var(--color-lumen-dark-800)",
  "lumen-dark-Default": "var(--color-lumen-dark-Default)",
  "lumen-dark-500-a8": "var(--color-lumen-dark-500-a8)",
  "lumen-dark-500-a16": "var(--color-lumen-dark-500-a16)",
  "lumen-dark-500-a24": "var(--color-lumen-dark-500-a24)",
  "lumen-dark-500-a40": "var(--color-lumen-dark-500-a40)",
  "lumen-dark-500-a60": "var(--color-lumen-dark-500-a60)",
  "lumen-dark-500-a80": "var(--color-lumen-dark-500-a80)",
  "nightshade-50": "var(--color-nightshade-50)",
  "nightshade-100": "var(--color-nightshade-100)",
  "nightshade-200": "var(--color-nightshade-200)",
  "nightshade-300": "var(--color-nightshade-300)",
  "nightshade-400": "var(--color-nightshade-400)",
  "nightshade-500": "var(--color-nightshade-500)",
  "nightshade-600": "var(--color-nightshade-600)",
  "nightshade-700": "var(--color-nightshade-700)",
  "nightshade-800": "var(--color-nightshade-800)",
  "nightshade-900": "var(--color-nightshade-900)",
  "nightshade-950": "var(--color-nightshade-950)",
  "nightshade-500-a8": "var(--color-nightshade-500-a8)",
  "nightshade-500-a16": "var(--color-nightshade-500-a16)",
  "nightshade-500-a24": "var(--color-nightshade-500-a24)",
  "nightshade-500-a40": "var(--color-nightshade-500-a40)",
  "nightshade-500-a60": "var(--color-nightshade-500-a60)",
  "nightshade-500-a80": "var(--color-nightshade-500-a80)",
  "overlay-black-4": "var(--color-overlay-black-4)",
  "overlay-black-5": "var(--color-overlay-black-5)",
  "overlay-black-8": "var(--color-overlay-black-8)",
  "overlay-black-10": "var(--color-overlay-black-10)",
  "overlay-black-15": "var(--color-overlay-black-15)",
  "overlay-black-30": "var(--color-overlay-black-30)",
  "overlay-black-50": "var(--color-overlay-black-50)",
  "overlay-black-60": "var(--color-overlay-black-60)",
  "overlay-black-70": "var(--color-overlay-black-70)",
  "overlay-white-6": "var(--color-overlay-white-6)",
  "overlay-white-10": "var(--color-overlay-white-10)",
  "overlay-transparent": "var(--color-overlay-transparent)",
  "status-green": "var(--color-status-green)",
  "status-green-light": "var(--color-status-green-light)",
  "status-green-tint": "var(--color-status-green-tint)",
  "status-amber": "var(--color-status-amber)",
  "status-amber-light": "var(--color-status-amber-light)",
  "status-amber-tint": "var(--color-status-amber-tint)",
  "status-green-15": "var(--color-status-green-15)",
  "status-amber-15": "var(--color-status-amber-15)",
  ...
  "background-pressed": "var(--color-background-pressed)",
  "background-overlay": "var(--color-background-overlay)",
  "background-chat-input": "var(--color-background-chat-input)",
  "background-chat-response": "var(--color-background-chat-response)",
  "background-toaster-bg": "var(--color-background-toaster-bg)",
  "background-toaster-systeminfo-bg": "var(--color-background-toaster-systeminfo-bg)",
  "background-table-bg": "var(--color-background-table-bg)",
  "background-table-header-bg": "var(--color-background-table-header-bg)",
  "background-table-text": "var(--color-background-table-text)",
  "background-code": "var(--color-background-code)",
  "background-disabled": "var(--color-background-disabled)",
  "background-avatar": "var(--color-background-avatar)",
  "background-brand-tint": "var(--color-background-brand-tint)",
  "background-status-success": "var(--color-background-status-success)",
  "background-status-warning": "var(--color-background-status-warning)",
  ...
  "text-success-muted": "var(--color-text-success-muted)",
  "text-warning": "var(--color-text-warning)",
  "text-danger": "var(--color-text-danger)",
  "text-badge": "var(--color-text-badge)",
  ...
  "border-toaster": "var(--color-border-toaster)",
  ...
  "icon-lumen-bg": "var(--color-icon-lumen-bg)",
  "icon-nav": "var(--color-icon-nav)",
  "icon-on-brand": "var(--color-icon-on-brand)",
  "icon-inactive": "var(--color-icon-inactive)",
  "icon-nav-default": "var(--color-icon-nav-default)",
  "icon-nav-hover": "var(--color-icon-nav-hover)",
  "icon-nav-selected": "var(--color-icon-nav-selected)",
  "icon-theme-toggle": "var(--color-icon-theme-toggle)",
  "icon-primary-icon": "var(--color-icon-primary-icon)",
  "icon-info-bg": "var(--color-icon-info-bg)",
  "icon-info-icon": "var(--color-icon-info-icon)",
  "icon-error-bg": "var(--color-icon-error-bg)",
  "icon-error-icon": "var(--color-icon-error-icon)",
  "icon-success-bg": "var(--color-icon-success-bg)",
  "icon-success-icon": "var(--color-icon-success-icon)",
  "icon-warning-bg": "var(--color-icon-warning-bg)",
  "icon-warning-icon": "var(--color-icon-warning-icon)",
  ...
  "button-neutral-disabled-border": "var(--color-button-neutral-disabled-border)",
  ...
  "auth-hero-text-caption": "var(--color-auth-hero-text-caption)",
  "auth-hero-badge-text": "var(--color-auth-hero-badge-text)",
  "auth-hero-badge-border": "var(--color-auth-hero-badge-border)",
  "auth-hero-divider": "var(--color-auth-hero-divider)",
  "auth-hero-status-dot": "var(--color-auth-hero-status-dot)",
  ...
  "app-shell-avatar-tablet-bg": "var(--color-app-shell-avatar-tablet-bg)",
  "app-shell-nav-active": "var(--color-app-shell-nav-active)",
  "app-shell-nav-hover": "var(--color-app-shell-nav-hover)",
  "app-shell-nav-bg": "var(--color-app-shell-nav-bg)",
  "app-shell-nav-on-action": "var(--color-app-shell-nav-on-action)",
  "app-shell-nav-selected-on-action": "var(--color-app-shell-nav-selected-on-action)",
  "app-shell-icon-default": "var(--color-app-shell-icon-default)",
  "app-shell-icon-secondary": "var(--color-app-shell-icon-secondary)",
  ...
  "app-shell-text-tertiary": "var(--color-app-shell-text-tertiary)",
  ...
  "app-shell-brand-dark": "var(--color-app-shell-brand-dark)",
  ...
  "app-shell-bot-icon": "var(--color-app-shell-bot-icon)",
  "app-shell-toggle-bg": "var(--color-app-shell-toggle-bg)",
  "app-shell-toggle-track": "var(--color-app-shell-toggle-track)",
  "app-shell-toggle-on-action": "var(--color-app-shell-toggle-on-action)",
  "app-shell-toggle-on-bg": "var(--color-app-shell-toggle-on-bg)",
  "app-shell-toggle-off-action": "var(--color-app-shell-toggle-off-action)",
  "app-shell-toggle-off-bg": "var(--color-app-shell-toggle-off-bg)",
  ...
  "app-shell-button-secondary-on-action": "var(--color-app-shell-button-secondary-on-action)",
  "app-shell-button-secondary-text": "var(--color-app-shell-button-secondary-text)",
  "app-shell-button-primary-bg": "var(--color-app-shell-button-primary-bg)",
  "app-shell-button-primary-on-action": "var(--color-app-shell-button-primary-on-action)",
  "app-shell-button-accent-bg": "var(--color-app-shell-button-accent-bg)",
  "app-shell-button-accent-on-action": "var(--color-app-shell-button-accent-on-action)",
