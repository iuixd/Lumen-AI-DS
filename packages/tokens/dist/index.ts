...
export const typography = {
  ...
  "scale": {
    ...
    "body-sm-medium": {
      ...
      "lineHeight": 22,
      "weight": 500,
      "usage": "Medium-weight fine print (Figma 'Body/Small Medium') — footer button labels and active (non-disabled) file-row filenames in FileUploadProgressList. Figma-evidenced 2026-08-03 via get_variable_defs on Lumen-AI-Design-System nodes 1565:3298/1565:3337, exact match to this file's existing `body-sm`/`app-caption`-vs-`app-caption-medium` naming convention (same size/line-height as the regular tier, weight bumped to 500)."
    },
    "body-xs": {
      "fontSize": 12,
      "lineHeight": 20,
